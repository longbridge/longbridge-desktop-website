...
const items: UpgradeItem[] = [
    {
        ...
        description: [
            {
                style: "text-lg lg:text-xl font-bold",
                text: upgrade.tab1.description_1,
            },
            {
                ...
                children: [
                    {
                        style: "ml-1 self-end",
                        text: upgrade.tab1.description_3,
                    },
                ],
            },
        ...
        image: "https://assets.lbctrl.com/uploads/0f2ea591-c73c-41f7-8f71-276df926007a/flag-1.png",
    },
    {
        ...
        description: [
            {
                style: "text-lg lg:text-xl font-bold",
                text: upgrade.tab2.description_1,
            },
            {
        ...
        image: "https://assets.lbctrl.com/uploads/581199f5-90c6-48b1-98fc-6fd8b626ffb9/flag-2.png",
    },
    {
        ...
        description: [
            {
                ...
                children: [
                    {
                        style: "mb-1 lg:mb-4 ",
                        text: upgrade.tab3.description_2,
                    },
                ],
            },
            {
                ...
                class: "flex-col",
                children: [{ style: "", text: upgrade.tab3.description_4 }],
            },
        ],
        image: "https://assets.lbctrl.com/uploads/4332bbcc-c031-4ae3-a1ae-7006a05cca83/flag-3.png",
...
<template>
    <section class="relative flex items-center px-6" ref="flow">
        <div class="w-full mx-10 lg:mx-auto lg:w-5xl">
            <div
            ...
            <div
                class="grid md:grid-cols-3 gap-8 grid-cols-1 [&>div]:(bg-gray-50 rounded-xl p-3 lg:p-6 shadow-lg border border-gray-200 md:h-97 h-48)"
            >
                <div
                ...
                >
                    ...
                    >
                        <div
                            class="font-semibold text-left text-black text-6.5"
                        >
                            <span v-html="item.title"></span>
                        </div>
                        <div
                            :class="[
                                'z-10 flex-1 flex flex-col justify-end space-y-0.5 lg:space-y-2 text-left text-black',
                                item.class,
                            ]"
                        >
                            <div
                                :class="['text-14px lg:text-16px', desc.class]"
                                v-for="desc in item.description.filter(
                                    (desc) => desc.text,
                                )"
                                :key="desc.text"
                            >
