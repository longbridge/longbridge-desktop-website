...
<template>
    <div>
        <div
            class="flex flex-wrap items-center gap-4 justify-center mb-4 lt-sm:(flex-col [&>a]:(w-35%))"
        >
        ...
        <div class="text-sm font-medium flex flex-col items-center">
            <p class="flex items-center gap-1">
                <span class="flex items-center gap-1">
                    ...
                    <span
                        class="bg-orange-500 text-white px-1 rounded-md text-xs"
                        >Beta</span
                    >
                </span>
                <a
            ...
            <div
                class="text-sm text-[var(--lb-gray-1)] mt-4 py-1 px-4 [&_a]:(text-[var(--vp-c-brand-3)] !no-underline)"
                v-html="legacy_info"
            ></div>
        </div>
    </div>
