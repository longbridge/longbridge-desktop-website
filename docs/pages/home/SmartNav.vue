    ...
    <div class="bg-gray-50">
        <section class="py-16 lg:py-24 px-8">
            <div class="max-w-[1200px] mx-auto">
                <div
                    class="flex lt-sm:(flex-col) flex-row justify-between items-center bg-white rounded-xl"
                >
                    <!-- 左侧内容 -->
                    <div class="space-y-8 flex flex-col justify-between h-full">
                        <div class="pt-12 px-12 lt-sm:(px-8 pt-4)">
                            <h1
                                class="text-4xl lg:text-5xl xl:text-6xl font-bold text-black leading-tight"
                            >
                    ...
                    <!-- 右侧图片 -->
                    <div
                        class="flex justify-center lg:justify-end py-4 px-4 lg:pl-0"
                    >
