        ...
        <div class="max-w-[1200px] mx-auto pt-8 lg:pt-24">
            ...
            <div class="relative">
                ...
                <button @click="previousTab"
                    ...
                    <svg class="w-4 h-4 text-gray-600 lg:w-5 lg:h-5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                ...
                <div class="mx-4 lg:mx-12">
                    ...
                    <div class="flex justify-center mb-8">
                        ...
                        <img v-else :src="tabs[activeTab].image" :alt="tabs[activeTab].title"
                            class="w-88 lg:w-172 rounded-lg" v-motion="motionVisible(300)" />
                    </div>
                        ...
                        <div class="flex space-x-8 border-b border-gray-200 lg:space-x-12">
                            <button v-for="(tab, index) in tabs" :key="index" @click="setActiveTab(index)"
                                ...
                                :class="index === activeTab
                                    ...
                                    : 'text-[var(--lb-gray-1)]'
                                    ">
                                <svg class="flex-shrink-0 w-4 h-4 lg:w-5 lg:h-5" fill="currentColor" width="19"
                                ...
                                <!-- Active underline -->
                                <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-black transition-all duration-300"
                                    :class="index === activeTab
                                ...
                                <!-- Hover underline -->
                                <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gray-300 transition-all duration-300 opacity-0 scale-x-0 group-hover:opacity-100 group-hover:scale-x-100"
