...
import { useLocale, motionVisible, useDetectMobile } from "./utils";

const { realTimeTracking } = useLocale();
const isMobile = useDetectMobile();

const vMotion = !isMobile.value
  ? {
    initial: {
      opacity: 0,
      y: -420,
    ...
    <div class="max-w-[1200px] mx-auto pt-24">
      ...
      <div class="relative">
        ...
        <button @click="previousTab"
          ...
          <svg class="w-4 h-4 text-gray-600 lg:w-5 lg:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mx-4 lg:mx-12">
          ...
          <div class="flex justify-center mb-8">
            ...
            <img v-else :src="tabs[activeTab].image" :alt="tabs[activeTab].title"
              class="w-88 h-49 lg:w-172 lg:h-98 rounded-lg" v-motion="motionVisible(300)" />
          </div>

          <!-- Tabs with underline style -->
          <div class="flex justify-center mb-6 border-b border-gray-200 border-b-solid">
            <div class="flex space-x-8 border-b border-gray-200 lg:space-x-12">
              <button v-for="(tab, index) in tabs" :key="index" @click="setActiveTab(index)"
                ...
                :class="index === activeTab
                  ...
                  : 'text-[var(--lb-gray-1)]'
                  ">
                <svg class="flex-shrink-0 w-4 h-4 lg:w-5 lg:h-5" fill="currentColor" width="19" height="18"
                  viewBox="0 0 19 18">
                  <path v-if="index === 2"
                  ...
                  <template v-if="index === 1">
                    <path d="M9.2627 0V8H0.262695V0H9.2627ZM2.2627 6H7.2627V2H2.2627V6Z" />
                    <path d="M9.2627 10V16H0.262695V10H9.2627ZM2.2627 14H7.2627V12H2.2627V14Z" />
                    <path d="M16.2627 0V16H10.7627V0H16.2627ZM12.7627 14H14.2627V2H12.7627V14Z" />
                  </template>
                  <path v-if="index === 0"
                ...
                <span class="sm:hidden">{{ tab.title.split(" ")[0] }}</span>

                <!-- Active underline -->
                <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-black transition-all duration-300" :class="index === activeTab
                ...
                <div
                  ...
                  :class="index === activeTab ? 'hidden' : ''"></div>
              </button>
            </div>
          </div>
          ...
          <div class="flex justify-center">
            <p class="max-w-2xl mx-auto !text-base text-black lg:text-lg">
