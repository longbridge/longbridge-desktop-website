...
import RenderMoneyRadar from "./RenderMoneyRadar.vue";
...
<template>
  <section class="px-6 pb-18">
    <div class="max-w-6xl mx-auto pt-24">
      <h2
        class="!text-3xl lg:!text-4xl font-bold text-center !mb-10 text-black !pt-0"
        v-motion="
      ...
      <div class="relative">
        ...
        <div class="mx-4 lg:mx-12">
          ...
          <div class="flex justify-center">
            <p class="max-w-2xl mx-auto text-base text-gray-600 lg:text-lg">
